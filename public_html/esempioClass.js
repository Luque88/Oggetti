...
class Lega {
  ...
  class Partita {
      ...
      dammiRisultato(){
          //es ha vinto mastini 30 punti contro 12 sirbons
          let ris="";
          if (this.pt1>this.pt2)
          ris= "Ha vinto" + this.sq1 + "" + this.pt2 + "punti contro" + this.pt1 + "di" + this.sq2;
      else
       ris= "Ha vinto" + this.sq2 + "" + this.pt1 + "punti contro" + this.pt2 + "di" + this.sq1;
   return ris;
  }
